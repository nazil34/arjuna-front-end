              ...
              <div class="register-box p-4 rounded-4 shadow">
                ...
                <form id="registerForm">
                  <div class="mb-3">
                    ...
                    <input type="text" id="registerUsername" class="form-control rounded-3 py-2" placeholder="Enter your chosen Hero Name">
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Email</label>
                    <input type="email" id="registerEmail" class="form-control rounded-3 py-2" placeholder="Enter your Sky Scroll (e.g., hero@mail.com)">
                  </div>
                  <div class="mb-4">
                    <label class="form-label">Password</label>
                    <input type="password" id="registerPassword" class="form-control rounded-3 py-2" placeholder="Create your Secret Mantra">
                  </div>
